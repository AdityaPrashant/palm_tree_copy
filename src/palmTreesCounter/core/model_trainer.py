...
class Training:
    ...
    def get_data_loaders(self):
        ...
        test_dataset = PalmTreeDataset(test_df[0:100], test_img_dir, transforms=transforms, train=False, target_size=(self.config.params_image_size, self.config.params_image_size))
